...
all_exp <- list(
  ...
  list(
    ...
    "year" = "2015 - 2017",
    "detail" = c(
      "Led a five person development team as the principal developer for Clear Capital’s AVM, a system that generated 150 million weekly predictions and annual revenues exceeding \\$5 million as of 2021.",
  ...
  list(
    ...
    "detail" = c(
      ...
      "Transformed AVM performance from last place among 31 vendors to become an industry leader within just 6 months, contributing to additional annual revenues exceeding \\$1 million.",
